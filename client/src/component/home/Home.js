      ...
      <div className="third-section">
        <div className="left-side">
          <div>
            ...
            <p>
              Transforming legal understanding. <br /><br/>
              Simplify legal contracts, save time. Our app unlocks accessibility
              for individuals with cognitive disabilities by transforming
              complex PDFs. Quick comprehension, empowered decisions.
              <br/><br/>
            </p>
          </div>
